...
需要注意的是，系统是欠驱动还是全驱动与系统状态和时间有关，同一系统在不同的状态时系统定义可能判定结果可能不同。对于大多数的机器人系统，多是欠驱动。对于水下机器人，水下机器人处于水中和水面的系统判定结果就不同。在本章中，对水下机器人进行系统判定是在水下机器人完全处于水中，且在水中不受别的力干扰。完全驱动的系统比欠驱动系统更加容易控制，下面将采用上述定义对于本章后续介绍的ROV和AUV进行判定。
